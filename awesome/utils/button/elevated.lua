...
function elevated_button.state(args)
	...
	args.bg_hover_on = args.bg_hover_on
		or color_lib.lightness(color_lib.isDark(args.bg_normal_on) and "lighten" or "darken", 20, args.bg_normal_on)
...
function elevated_button.normal(args)
	...
	args.hover_border_color = args.hover_border_color
		or color_lib.lightness(color_lib.isDark(args.bg_normal) and "lighten" or "darken", 16, args.normal_border_color)
